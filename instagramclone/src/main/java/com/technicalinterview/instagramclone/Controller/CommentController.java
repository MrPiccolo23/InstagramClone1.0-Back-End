...
public class CommentController {
	...
	private ArrayList<Comments> getCommentsForPost(@PathVariable("userId") String userId, @PathVariable("postId") String postId){
	    return commentsService.getAllCommentsForUser(userId);
	}
